...
// main page
app.get("/", (req, res) => {
  res.send("<h1>Hello From Main Page You Have To Enter Data Like The Below Example To See Results</h1><h2>img?name='Image Name'&width='width number'&height='Height Number'</h2>");
